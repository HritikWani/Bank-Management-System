...
private JLabel acc_no_lbl,from_lbl,to_lbl;
private JTextField ac_no_fld;
private JButton back,show,clear,print;
private String column[]={"Transaction ID","Date & Time","Amount","Type","Final Balance","Account Number"};         
...
//           f=new JFrame();    
 ...
 //      label1.setOpaque(true);
        ...
        add(label1);
                ...
                ac_no_fld = new JTextField();
                ac_no_fld.setFont(new Font("Times New Roman", Font.BOLD, 25));
                ac_no_fld.setBounds(30, 150, 250, 35);
                add(ac_no_fld);

        
             acc_no_lbl = new JLabel();
            acc_no_lbl.setFont(new Font("Times New Roman", Font.BOLD, 20));
            acc_no_lbl.setBounds(75, 180, 220, 35);
            acc_no_lbl.setText("Account Number ");
            add(acc_no_lbl);
           ...
           print.addActionListener(this);
            ...
            JLabel     lbl_all_tr = new JLabel();
            lbl_all_tr.setFont(new Font("Times New Roman", Font.BOLD, 30));
            lbl_all_tr.setBounds(30, 250, 810, 35);
            lbl_all_tr.setText("All Transactions");
            add(lbl_all_tr);
            
     //    String data[][]={ {"101","Amit","670000","A","200"}};    
            String query="select * from transactionstatement ";
            String data[][] =null;
            String countquery = "select  count(*) as rowc from transactionstatement";
            try {
        ...
        try{
            ...
            if (ae.getSource()==back){
              ...
              jt.setModel(new DefaultTableModel(data,column));
                ...
                String s_acno=ac_no_fld.getText().trim();
               ...
               if(!s_acno.isBlank() && !from_date.isBlank() && !to_date.isBlank()) {
                   account_number=Long.parseLong(s_acno);
                   ...
                   countquery = "select  count(*) as rowc from transactionstatement "+
                           ...
                           " and tr_date_time between '"+from_date+" 00:00:00' and '"+to_date+" 23:59:59'";
               }else if(!from_date.isBlank() && !to_date.isBlank()){
                       query=query+ " where tr_date_time between '"+from_date+" 00:00:00' and '"+to_date+" 23:59:59'";
                        countquery = "select  count(*) as rowc from transactionstatement "+
                                " where tr_date_time between '"+from_date+" 00:00:00' and '"+to_date+" 23:59:59'";
               }else if(!s_acno.isBlank()) {
                    account_number=Long.parseLong(s_acno);
                    query=query+ " where account_number="+account_number;
                      countquery = "select  count(*) as rowc from transactionstatement "+
                              " where account_number="+account_number;
     ...
     private String[][] loadtransaction(String trquery,String countquery) throws Exception{
         ...
         try{
           ...
           while(rs2.next()){
            ...
            data[row][5] = rs2.getString("account_number");
            row++;
           }
    ...
    private void print() {
        ...
        try {
            ...
            for (int i = 0; i < jt.getRowCount(); i++) {
                ...
                String acno = jt.getValueAt(i, 5).toString();
